...
export const products: Product[] = [
  ...
  // ─── Planters ─────────────────────────────────────────
  {
    ...
    tagline: "UV-stable indoor planters in eight colour finishes.",
    capacity: "5 L – 30 L",
    description:
      "Lightweight yet durable indoor planters with a UV-stabilised colour finish and a drainage hole with plug. Available in eight colours to suit any interior.",
    badges: ["UV Stable"],
    features: [
